 ...
 */
class ExtendInstagram extends Instagram
{
    /**
        ...
        $password)
    {
        ...
        if ($deviceString !== $savedDeviceString // Brand new device, or missing
            ...
            $this->settings->set('devicestring', $this->devicestring ?? $deviceString);

            // Generate hardware fingerprints for the new device.
            $this->settings->set('device_id', $this->device_id ?? Signatures::generateDeviceId());
            $this->settings->set('phone_id', $this->phone_id ?? Signatures::generateUUID(true));
            $this->settings->set('uuid', $this->uuid ?? Signatures::generateUUID(true));
